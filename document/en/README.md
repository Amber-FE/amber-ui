---
home: true
heroImage: https://www.onekdrug.com/_nuxt/img/33ca385.png
heroText: Amber UI
...
<div style="display:flex;justify-content: space-between;padding-bottom:40px">
  ...
  <div style="display: flex;flex-direction: column;align-items: center;">
    ...
    <p style="margin:0px;font-size: 14px;color:#666">Controllability</p>
  </div>
</div>
